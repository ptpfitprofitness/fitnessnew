	...
	function validatefrmsfd()
    {
	 ...
	 //var range=$('#rangeA').val();
	  ...
	  var sessTime = $('#customSelectTime').val();
		...
		if(trainer_id!='' && groupid!='' && sessType!='-- Session Availability --'){
					
		//sbtn
		//return true;$data['Club']['username']=$this->request->data['username'];		
		 var website_url ='<?php echo $config['url']?>home/add_exercise_history_group';
				$.ajax({
		   		type: "POST",
		   		url: website_url,
                ...
                window.opener.location.href='<?php echo $config['url'].'home/scheduling_calendar';?>/'+pdts;
           	    window.close();
...
<style>
.overlaybox{background:none;}
header{display:none;}
footer{display:none;}
.register-form-popup{left:23%;top:30%;}
...
@media only screen and (max-width: 360px) and (min-width: 320px) {
 ...
 form{clear:both;}
  ...
  <div class="clear"></div>
                ...
                <div id="popFd" class="main-popup" style="display:block;">
                  <div class="overlaybox common-overlay"></div>
                  <div id="thirtydays" class="register-form-popup common-overlaycontent" style="width:684px;margin-left:-140px;"> <!--<a class="close-nav" onclick="popupClose('popFd');" id="pop4" href="javascript:void(0);"></a>-->
        ...
        <h2>Build a Group Workout</h2>
         ...
         <table border='1' width='100%' id="a">
				...
				<tr class='slectedmn'>
				<td width="100%" colspan='4' class="th2"><h3 style='text-align:left;float:left;'>Group Name:   </h3> <span id="clnamewt" style="float: left; line-height: 32px;  padding: 10px 5px 5px;"><?php echo $setGroupArr['Group']['group_name'];?></span>
				</td>
...
?>
			...
			<tr class='slectedmn'>
				<td  class="th2"><span style="float: left; line-height: 36px;">Alert:</span><textarea id="alert" name="alert" style="width: 94%;"><?php if(!empty($setClientArr)){ echo $setClientArr['Trainee']['alerts'];}?></textarea></td>
