         ...
         //pr($clients);
          ...
          ?>
            <li>
              ...
              <div class="list-colum fifth-tabs"><a href="javascript:void(0);" onclick="edittrainer('<?php echo base64_encode($trainee['Trainee']['id']);?>');"><img src="<?php echo $config['url'];?>images/editicon.png"></a>  <a href="javascript:void(0);" onclick="deletetrainer(<?php echo $trainee['Trainee']['id'];?>);"><img src="<?php echo $config['url'];?>images/deleteicon.png"></a>
