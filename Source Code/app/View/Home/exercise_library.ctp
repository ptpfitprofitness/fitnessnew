...
?> 
 ...
 <form accept-charset="utf-8" method="post" id="validcertificationtrainers" class="resform-wrap" enctype="multipart/form-data" controller="home" action="/home/exercise_library/">
		<?php 
...
<div class="main-responsive-box" style="margin:15px 0 0 0;"><ul class="listing-box">
    ...
    border-left: 1px solid #CCCCCC;"><div class="list-scroll-wrap" id="testDivNested" >
       ...
       <?php echo $this->Form->text('CertificationTrainers.vidid][', array('type'=>'checkbox', 'value'=>$video['ExerciseLibrary']['id'],  'onclick'=>"checkSelection('data[CertificationTrainers][vidid][]', 'data[CertificationTrainers][all]')"));?> 
              </div>
              <div class="list-colum second-tabs"><?php if(!empty($video['ExerciseLibrary']['doc_name'])){echo $video['ExerciseLibrary']['doc_name']; }; ?></div>
              <div class="list-colum third-tabs"><?php if(!empty($video['ExerciseLibrary']['description'])){echo  $video['ExerciseLibrary']['description']; };  ?></div>
