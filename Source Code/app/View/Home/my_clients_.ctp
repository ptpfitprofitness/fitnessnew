      ...
      <div class="eight inside-head columns">
        ...
        <div class="main-responsive-box"><ul class="listing-box all-headtabs">
          <li class="listing-heading">
            ...
            <div class="list-colum four-tabs">Address</div>
            <div class="list-colum fifth-tabs">Phone</div>
          </li>
        </ul>
        ...
        //  pr($clients);
          ...
          ?>
            <li>
              ...
              <div class="list-colum second-tabs"><?php if(!empty($client['Trainee']['full_name'])){echo $client['Trainee']['full_name']; }; ?></div>
              <div class="list-colum third-tabs"><?php if(!empty($client['Trainee']['email'])){echo  $client['Trainee']['email']; };  ?></div>
              <div class="list-colum four-tabs"><?php if(!empty($client['Trainee']['address'])){echo  $client['Trainee']['address']; };  ?></div>
              <div class="list-colum fifth-tabs"><?php if(!empty($client['Trainee']['phone'])){echo  $client['Trainee']['phone']; };  ?></div>
            </li>
         <?php   $cnt++; ?>
            <?php  }?>
