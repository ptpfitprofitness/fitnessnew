...
<div class="vtiger">      
    ...
    <?php } }?>
     ...
     <table border='1'>
     <tr class="slectedmn">
     <th colspan="5"><h3 style="text-align:center;">Three Site Body Fat Index</h3><span><?php echo date('l jS F Y',strtotime($response_threesite[1]['ThreesiteBodyfat']['created_date']));?></span></th>
     </tr>
	     <tr>
		        
		     <th>Age</th>
		     <?php if($response_threesite[1]['ThreesiteBodyfat']['gender']=='Male'){?>
		     <th>Chest</th>
		     <th>Abdominal</th>
		     <th>Thigh</th>
		     <?php } else{?>
   ...
   echo $this->GoogleChart->create()
    ...
    <?php } }?>
     ...
     <table border='1'>
     <tr class="slectedmn">
     <th colspan="5"><h3 style="text-align:center;">Three Site Body Fat Index</h3><span><?php echo date('l jS F Y',strtotime($response_threesite[0]['ThreesiteBodyfat']['created_date']));?></span></th>
     </tr>
	     <tr>
		        
		     <th>Age</th>
		     <?php if($response_threesite[0]['ThreesiteBodyfat']['gender']=='Male'){?>
		     <th>Chest</th>
		     <th>Abdominal</th>
		     <th>Thigh</th>
		     <?php } else{?>
