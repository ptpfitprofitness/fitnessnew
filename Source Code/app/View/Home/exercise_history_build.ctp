  ...
  <div class="clear"></div>
        ...
        <h2>Build a Workout</h2>
         ...
         <table border='1' width='100%' id="a">
				...
				<tr class='slectedmn'>
				<td width="100%" colspan='4' class="th2"><h3 style='text-align:left;float:left;'>Client Name:   </h3> <span id="clnamewt" style="float: left; line-height: 32px;  padding: 10px 5px 5px;"><?php echo $setClientArr['Trainee']['full_name'];?></span>
				</td>
