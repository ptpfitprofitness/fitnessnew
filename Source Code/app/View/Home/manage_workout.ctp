    ...
    <div class="row">
     <?php echo $this->element('lefttrainer');?>
      <div class="eight inside-head columns">
        ...
        <input type="button" style="width:145px;" class="change-pic-nav" onclick="newtrainee();" value="Add Session Type" name="submit">
        </div>
        <div class="main-responsive-box"><ul class="listing-box all-headtabs">
          <li class="listing-heading">
           <!-- <div class="list-colum first-tabs" style="min-width:50px;">S.No.</div>-->
            ...
            <div class="list-colum third-tabs">Session Time/Price</div>
            <div class="list-colum four-tabs" style="min-width:180px;">Status</div>
         ...
         //pr($clients);
          ...
          ?>
            ...
            <!--  <div class="list-colum first-tabs" style="min-width:50px;"><?php //echo $cnt; ?></div>-->
              <div class="list-colum second-tabs"><?php if(!empty($workouts['WorkOuts']['workout_name'])){echo $workouts['WorkOuts']['workout_name']; };  ?></div>
              <div class="list-colum third-tabs"><?php if(!empty($workouts['WorkOuts']['workout_time'])){echo  $workouts['WorkOuts']['workout_time']; }; if(!empty($workouts['WorkOuts']['workout_price'])){echo '/ $'.$workouts['WorkOuts']['workout_price']; };  ?></div>
              <div class="list-colum four-tabs">  <?php 
						if(!empty($workouts['WorkOuts']['status'])==1){
              ...
              <div class="list-colum fifth-tabs"><a href="javascript:void(0);" onclick="edittrainer('<?php echo base64_encode($workouts['WorkOuts']['id']);?>');"><img src="<?php echo $config['url'];?>images/editicon.png"></a>  <a href="javascript:void(0);" onclick="deleteworkouts(<?php echo $workouts['WorkOuts']['id'];?>);"><img src="<?php echo $config['url'];?>images/deleteicon.png"></a></div>
            </li>
         <?php   $cnt++; ?>
            <?php  }?>
