...
function removePic(elem) {
	...
	if(r){
		...
		$.ajax({
				url:"<?php echo $config['url'];?>trainees/removePic/",
				type:"POST",
				data:{id:elem.id},
				success:function(e) {
					var response = eval(' ( '+e+' ) ');
   ...
   $(function() {
//bk( "#date1" ).datepicker();
$( "#purchasedate" ).datepicker({ minDate: 0, maxDate: "+1M +10D" })
});
</script>
<style>
    ...
    <div class="row">
     <?php echo $this->element('lefttrainer');?>
      <div class="eight inside-head columns">
        ...
        <div>
        <h2>Edit Client</h2>
        <form accept-charset="utf-8" method="post" id="validclubtrainer" class="resform-wrap" enctype="multipart/form-data" controller="home" action="/home/editclient/<?php echo base64_decode($trid);?>">
...
<?php echo $this->Form->text('Trainee.first_name', array('maxlength'=>255,'id'=>'FirstName','class'=>'validate[required]','placeholder'=>'First name')); ?>
            ...
            <div class="row">
              <div class="six columns">
              	<?php echo $this->Form->text('Trainee.phone', array('maxlength'=>255,'id'=>'Phone','class'=>'validate[required]','placeholder'=>'Phone 555-555-5555')); ?>

				<?php echo $this->Form->error('Trainee.phone', null, array('class' => 'error')); ?>
              </div>
              <div class="six columns">
                <?php echo $this->Form->text('Trainee.mobile', array('maxlength'=>255,'id'=>'Mobile','class'=>'validate[required]','placeholder'=>'Mobile 555-555-5555')); ?>
		   ...
		   <?php echo $this->Form->textarea('Trainee.about_us', array('maxlength'=>500, 'id'=>'AboutUs','placeholder'=>'About Us')); ?>
			...
			<?php echo $this->Form->textarea('Trainee.alerts', array('maxlength'=>1000, 'id'=>'Alerts','placeholder'=>'Alerts')); ?>
				
				<?php echo $this->Form->error('Trainee.alerts', null, array('class' => 'error')); ?>
					
             <div class="row" style="display:none;">
              <div class="six columns" style="position:relative;">
              	<?php echo $this->Form->text('Trainee.no_ses_purchased', array('maxlength'=>255,'id'=>'NoSessP','class'=>'validate[required]','placeholder'=>'0')); ?>

				<?php echo $this->Form->error('Trainee.no_ses_purchased', null, array('class' => 'error')); ?>
				<span style="position:absolute;right:15px;top:10px;z-index:99;color:#888">Number of session purchased</span>
              </div>
              <div class="six columns" style="position:relative;">
                <?php echo $this->Form->text('Trainee.booked_ses', array('maxlength'=>255,'id'=>'BookedSes','class'=>'validate[required]','placeholder'=>'0','readonly'=>'readonly')); ?>

				<?php echo $this->Form->error('Trainee.booked_ses', null, array('class' => 'error')); ?>
				<span style="position:absolute;right:15px;top:10px;z-index:99;color:#888">Number of booked session</span>
              </div>
            </div>
            <div class="row" style="display:none;">
              <div class="six columns" style="position:relative;">
              	<?php echo $this->Form->text('Trainee.ses_cost', array('maxlength'=>255,'id'=>'sescost','class'=>'validate[required]','placeholder'=>'0')); ?>

				<?php echo $this->Form->error('Trainee.ses_cost', null, array('class' => 'error')); ?>
				<span style="position:absolute;right:15px;top:10px;z-index:99;color:#888">Cost</span>
              </div>
              <div class="six columns" style="position:relative;">
                <?php echo $this->Form->text('Trainee.ses_purcahse_date', array('maxlength'=>255,'id'=>'purchasedate','class'=>'validate[required] datvs','placeholder'=>'MM/DD/YYYY')); ?>

				<?php echo $this->Form->error('Trainee.ses_purcahse_date', null, array('class' => 'error')); ?>
				<span style="position:absolute;right:15px;top:10px;z-index:99;color:#888">Session Purchased Date</span>
              </div>
            </div>
            <div class="row">
