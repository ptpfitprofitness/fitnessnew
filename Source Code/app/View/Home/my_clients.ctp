         ...
         //pr($clients);
          ...
          ?>
            <li>
              ...
              <div class="list-colum second-tabs"><?php if(!empty($client['full_name'])){echo $client['full_name']; }; ?></div>
              <div class="list-colum third-tabs"><?php if(!empty($client['email'])){echo  $client['email']; };  ?></div>
              <div class="list-colum four-tabs"><?php if(!empty($client['address'])){echo  $client['address']; };  ?></div>
              <div class="list-colum fifth-tabs"><?php if(!empty($client['phone'])){echo  $client['phone']; };  ?></div>
            </li>
         <?php   $cnt++; ?>
            <?php  }?>
