 	...
 	if(str=='c') 
 	{
 	  if($("#TraineeId").val()!='')	
 	  {
		...
		var stv='<?php echo $selectedslt;?>';
 		...
 		$('#d').show();
 		$('#k').hide();	
 		var clvid=$("#TraineeId").val();
 		 window.open("http://www.ptpfitpro.com/home/exercise_history_build/"+clvid+'/'+stv, "_blank", "fullscreen=no, height=500, toolbar=yes, scrollbars=yes, resizable=yes, top=200, left=200, width=800");
 	  }
 	  else
 	  {
