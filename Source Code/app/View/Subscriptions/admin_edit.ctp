...
<div class="content">
	<div class="content" id="container">
		<?php echo $this->Form->create('Subscription' ,array('controller'=>'subscriptions', 'action'=>'edit', 'enctype'=>'multipart/form-data', 'class'=>'mainForm', 'id'=>'valid')); ?>
		<?php echo $this->Form->hidden('Subscription.id'); ?>
		<!-- Input text fields -->
		<fieldset>
		<div class="widget first">
		<div class="head"><h5 class="iList">Edit Subscription Plan</h5><a href="<?php echo $this->Html->url(array('controller'=>'subscriptions', 'action'=>'index')); ?>" style="float: right; margin-top: 5px; padding: 2px 13px;margin-right:15px;" class='blueBtn'>List All</a></div> 
