...
<?php
			echo $this->Html->link('Active Certification.',array('controller'=>'certificationorganizations','action'=>'certificationactive'), array('target'=>'_blank','style'=>'background: #21ADED; padding:4px; margin:0 0 0 2px; color: #ffffff'));
			echo $this->Html->link('In Active Certifications.',array('controller'=>'certificationorganizations','action'=>'certificationinactive'), array('target'=>'_blank','style'=>'background: #21ADED; padding:4px; margin:0 0 0 15px; color: #ffffff'));
			?>
<div class="content"> 
			...
			<?php echo $this->Form->create('Certification',array('controller'=>'certificationorganizations','action'=>'certification/'.$this->params["pass"][0],'class'=>'mainForm')); ?>	
				<div class="">
					<div class="dataTables_filter" id="example_filter" style="right:15%;top:-38px;">
						<label>Search: <input type="text" name="keyword" value="<?php echo $keyword;?>" placeholder="Search by certification or organization..."/>
