...
<?php echo $this->Form->create('Employee' ,array('controller'=>'trainees', 'action'=>'add', 'enctype'=>'multipart/form-data', 'class'=>'mainForm', 'id'=>'valid')); ?>
<!-- Input text fields -->
...
<fieldset>
	...
	<div class="widget first">
		...
		<div class="head"><h5 class="iList">Add Employees</h5><a href="<?php echo $this->Html->url(array('controller'=>'employees', 'action'=>'index')); ?>" style="float: right; margin-top: 5px; padding: 2px 13px;margin-right:15px;" class='blueBtn'>List All</a></div>			
