...
<div class="content">
	<div class="content" id="container">
		<?php echo $this->Form->create('Form' ,array('controller'=>'Forms', 'action'=>'edit', 'enctype'=>'multipart/form-data', 'class'=>'mainForm', 'id'=>'valid')); ?>
		<?php echo $this->Form->hidden('Form.id'); ?>
		<?php echo $this->Form->hidden('Form.old_doc',array('value'=>$this->request->data['Form']['document'])); ?>
		
		<!-- Input text fields -->
		<fieldset>
		<div class="widget first">
		<div class="head"><h5 class="iList">Edit Form</h5><a href="<?php echo $this->Html->url(array('controller'=>'Forms', 'action'=>'index')); ?>" style="float: right; margin-top: 5px; padding: 2px 13px;margin-right:15px;" class='blueBtn'>List All</a></div> 
			...
			<div class="rowElem noborder"><label>File:</label><div class="formRight">
              <a href="<?php echo'/fitnessAaland/app/webroot/formuploads/'.$this->request->data['Form']['document']; ?>" /><?php echo $this->request->data['Form']['title']; ?></a>
