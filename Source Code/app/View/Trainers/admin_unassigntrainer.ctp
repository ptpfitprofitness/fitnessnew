...
<div class="table">
    <div class="head">
        ...
        <div class="dataTables_wrapper" id="example_wrapper">
			<?php echo $this->Form->create('Trainer',array('controller'=>'trainers','action'=>'unassigntrainer/'.$this->params["pass"][0],'class'=>'mainForm')); ?>	
				<div class="">
			...
			<?php 
				...
				if(isset($trainers) && count($trainers) > 0){
					$this->Paginator->options(array('url' => array("controller"=>"trainers","action"=>"unassigntrainer/$tab/keyword:$keyword")));
