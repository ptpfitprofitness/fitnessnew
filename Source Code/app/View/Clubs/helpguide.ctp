...
<div class="main-responsive-box" style="margin:15px 0 0 0;"><ul class="listing-box">
          <li class="listing-heading">
			...
			<div class="list-colum third-tabs">View Video</div>
        ...
        <ul class="listing-box">
         ...
         <?php   $cnt++; ?>
          ...
          </div><div style="background: none repeat scroll 0% 0% rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 358px;" class="slimScrollBar"></div><div style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: none repeat scroll 0% 0% rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;" class="slimScrollRail">
        </ul>
