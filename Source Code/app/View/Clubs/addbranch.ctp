    ...
    <div class="row">
     <?php echo $this->element('leftclub');?>
      <div class="eight inside-head columns">
        ...
        <div>
        <h2>Add Branch</h2>
        <form accept-charset="utf-8" method="post" id="validclubbranch" class="resform-wrap" enctype="multipart/form-data" controller="clubs" action="/clubs/addbranch/">
...
<?php echo $this->Form->text('ClubBranch.first_name', array('maxlength'=>255,'id'=>'FirstName','class'=>'validate[required]','placeholder'=>'Branch Manager First name')); ?>
              ...
              <div class="six columns">
				...
				<?php echo $this->Form->text('ClubBranch.last_name', array('maxlength'=>255,'id'=>'LastName','class'=>'validate[required]','placeholder'=>'Branch Manager Last name')); ?>
            ...
            <div class="row">
              <div class="six columns">
              	<?php echo $this->Form->text('ClubBranch.phone', array('maxlength'=>255,'id'=>'Phone','placeholder'=>'Phone 555-555-5555','class'=>'validate[required,custom[phone]] text-input','pattern'=>'\d{3}-?\d{3}-?\d{4}')); ?>
              ...
              <div class="six columns">
				...
				<?php echo $this->Form->text('ClubBranch.mobile', array('maxlength'=>255,'id'=>'Mobile','placeholder'=>'Mobile 555-555-5555','class'=>'validate[required,custom[phone]] text-input','pattern'=>'\d{3}-?\d{3}-?\d{4}')); ?>
