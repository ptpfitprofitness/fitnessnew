...
{	
	var website_url ='<?php echo $config['url']?>clubs/changecertorg';
	$.ajax({
		type: "POST",
		url: website_url,
		//data: "str="+str,
		...
		{	
			$("#TrainerCertificationId").html(msg);
         ...
         <?php }?>   
            ...
            <div class="row">
              <div class="twelve form-select columns">
				...
				echo $this->Form->select('Trainer.certification_org_id',$cert_org1,array('empty'=>'-- Select Certification Organization--','class'=>'sltbx','onchange'=>'document.getElementById(\'customSelectOrgid\').value= this.options[this.selectedIndex].text; changecertorg(document.getElementById(\'customSelectOrgid\').value= this.options[this.selectedIndex].text);')); ?>     
                
			
                <input type="text" id="customSelectOrgid" value="<?php if($this->data['Trainer']['certification_org']!=''){
			...
			<!--TEXTBOX HIDE-->
			  ...
			  echo $this->Form->select('Trainer.certification_id',$certifications1,array('empty'=>'-- Select Certification --','class'=>'topAction','onchange'=>'document.getElementById(\'customSelectCrtid\').value= this.options[this.selectedIndex].text')); ?>
                ...
                <input type="text" id="customSelectCrtid" value="<?php if($this->data['Trainer']['certification_name']!=''){
