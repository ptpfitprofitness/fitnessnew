...
<form accept-charset="utf-8" method="post" id="valid" class="resform-wrap" enctype="multipart/form-data" controller="foods" action="/fitnessAaland/admin/foods/editfood/">
<!-- Input text fields -->
...
<fieldset>
	...
	<div class="widget first">
		...
		<!--<input type="hidden"  name="data[FoodNutritionLog][id]" id="FoodNutritionLogId" value="<?php echo $id;?>"/>   	-->
		<?php echo $this->Form->hidden('FoodNutritionLog.id'); ?>
