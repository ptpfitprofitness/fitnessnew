...
<title>Forgot Password | Admin | <?php echo $config['base_title']; ?></title>
    ...
    <div class="fixed">
       ...
       <div class="wrapper" style="width:1032px;">
            ...
            <div class="userNav">
				...
				<a href="<?php echo $this->Html->url(array('controller'=>'users', 'action'=>'login')); ?>" title="Login"><span>Login</span></a>
...
<div class="loginWrapper2" style="top:25%; left:36%; position:absolute;">
    ...
    <div class="loginPanel">
		...
		<?php echo $this->Form->create('Admin', array('id'=>'valid', 'url' => array('controller' => 'users', 'action' => 'forgotpassword'), 'class'=>'mainForm'));?>
            ...
            <fieldset>
                ...
                <div class="loginRow noborder">
                    ...
                    <label for="req1">Email <span style="color:red;">*</span>:</label>

                    <div class="loginInput">

						<?php echo $this->Form->input('Admin.email',array("id"=>"Email", "label"=>false, "class"=>"validate[required,custom[email]]", 'style' => 'width:170px;'));?>
                ...
                <div class="loginRow" style="padding-bottom:0px;">
                    ...
                    <input type="submit" value="Reset Password" class="greyishBtn submitForm" style="margin-bottom:15px;" />
...
<div id="footer" style="position:absolute;">
	...
	<div class="wrapper">
    	...
    	<span>&copy; Copyright 2011. All rights reserved. Powered by <a href="#" title="">Synapse India</a></span>
