    ...
    array(
      ...
      'type'=>'checkbox','div' => false
              ...
              <!--  <span>Yes, I agree to Personal Training Partners.com <a href="#">Terms and Conditions</a>.</span> -->
				...
				<span>Yes I agree to the Personal Training Partners <a href="<?php echo $config['url']?>terms-of-use" target="_blank">Terms of Use</a> and <a href="<?php echo $config['url']?>privacy-policy" target="_blank">Privacy Policy</a>.</span>
				</div>
            </div>
