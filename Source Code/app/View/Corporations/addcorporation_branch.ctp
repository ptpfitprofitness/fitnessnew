    ...
    <div class="row">
     <?php echo $this->element('leftcorporation');?>
      <div class="eight inside-head columns">
        ...
        <div>
        <h2>Add Corporation Branch</h2>
        <form accept-charset="utf-8" method="post" id="validcorporationbranch" class="resform-wrap" enctype="multipart/form-data" controller="clubs" action="/fitnessAaland/corporations/addcorporation_branch/">
