...
<section class="contentContainer clearfix">
    ...
    <div class="row">
      ...
      <form accept-charset="utf-8" method="post" id="validmycnts" class="resform-wrap" enctype="multipart/form-data" controller="corporations" action="/fitnessAaland/corporations/addmy_contact" onsubmit="return vaildateCorporation();">
