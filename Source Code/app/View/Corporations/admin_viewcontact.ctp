...
##  Description :		view CorporationContact info
## *****************************************************************
?>
<div class="content">
	<div class="title">
...
<?php //pr($clubInfo); ?>
		<div class="widget first">
			...
			<div class="rowElem noborder"><label>Title<span style="color:red;">&nbsp;</span>:</label><div class="formRight" style="margin:0px;">
				<?php echo $clubInfo['CorporationContact']['title']; ?>
			</div><div class="fix"></div></div>
			...
			<div class="rowElem noborder">
				...
				<div class="formRight" style="margin:0px;">
					<?php echo $clubInfo['CorporationContact']['email']; ?>
				</div>
				<div class="fix"></div>
			</div>
			<div class="fix"></div>
			...
			<div class="rowElem noborder">
				<label>Mobile:</label>
				<div class="formRight" style="margin:0px;">
					<?php echo $clubInfo['CorporationContact']['mobile']; ?>
				</div>
				<div class="fix"></div>
			</div>
			...
			<div class="rowElem noborder">
				<label>Phone:</label>
				<div class="formRight" style="margin:0px;">
					<?php echo $clubInfo['CorporationContact']['phone']; ?>
				</div>
				<div class="fix"></div>
			</div>
			...
			<div class="rowElem noborder">
				...
				<div class="formRight" style="margin:0px;">
					<?php echo $clubInfo['CorporationContact']['date_enrolled']; ?>
				</div>
				<div class="fix"></div>
			</div>
