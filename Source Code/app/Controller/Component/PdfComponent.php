...
class PdfComponent extends Object {
  ...
  function init() {
      ...
      App::import('vendor', 'Html2PsConfig', array('file' => 'html2pdf'.DS.'config.inc.php'));
      App::import('vendor', 'Html2Ps', array('file' => 'html2pdf'.DS.'pipeline.factory.class.php'));
      parse_config_file(APP .'vendors'. DS .'html2pdf'. DS .'html2ps.config');
