...
class AutharbComponent extends Component {
...
function parse_return($content)
{
	...
	$customerPaymentProfileId = $this->substring_between($content,'<customerPaymentProfileId>','</customerPaymentProfileId>');
	$customerAddressId = $this->substring_between($content,'<customerAddressId>','</customerAddressId>');
	return array ($refId, $resultCode, $code, $text, $subscriptionId, $customerProfileId, $customerPaymentProfileId, $customerAddressId);
}
