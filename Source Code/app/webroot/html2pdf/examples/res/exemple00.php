...
<page style="font-size: 14px">
	<table width="1800">		
	<tr bgcolor="#EAF6FE" class="frRow">
		<td><label>CustRef#</label><br><input type="text" readonly value="58432" id="cust_agree_det_id" style="width: 50px;"></td><td><label>Type</label><br><input type="text" readonly value="Quote" id="hidden_agrtype"></td>
		<td><label>Valid From</label><br><input type="text" readonly value="" id="selected_date_from"></td>
		<td><label>Valid To</label><br><input type="text" readonly value="" id="selected_date_to"></td>
		<td><label>Supplier</label><br><input type="text" id="loc_supp" size="25" readonly value="Pandair Airline Handling Services"></td>
		<td><label>FBO</label><br><input type="text" name="Fbo_Fk" id="Fbo_Fk" size="25" readonly value=""></td>
		<td><label>Into-Plane Agent</label><br><input type="text" id="main_intoplane" readonly value="PPT (LCA)" size="25"></td>
		<td><label>Release Validity</label><br><input type="text" readonly value="Same Day" id="parameter_name" size="15"></td>
		<td><label>Fuel</label><br><input type="text" readonly value="Jet A-1" id="fuel_type_main"></td></tr>		
	</table>
    ...
    <br>
    Alignement horizontal des tds et TABLEs<br />
    ...
    <td style="text-align: center; border: solid 2px red; background: #FFEEEE;width: 40%; margin: auto">Test 3</td><br />
