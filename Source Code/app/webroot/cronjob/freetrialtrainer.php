...
if (mysql_num_rows($result) > 0) {
	...
	if ($actual_diff == 17 && $row["trainer_type"] == I && ($row["subscriptionplan"] == '' || $row["subscriptionplan"] == NULL))
		{
	...
	elseif ($actual_diff == 0 && $row["trainer_type"] == I && ($row["subscriptionplan"] == '' || $row["subscriptionplan"] == NULL))
		{
			//echo "This is true condition";
			$to = $row["email"];
			$subject = 'Your PTPFitPro trial is ending soon';
