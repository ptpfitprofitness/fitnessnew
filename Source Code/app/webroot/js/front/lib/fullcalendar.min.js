...
(function(t, e) {
    ...
    function K(n, r, a) {
        ...
        function g() {
            ...
            a += "<th class='fc-agenda-gutter " + r + "'>&nbsp; </th>" + "</tr>" + "";
              for (a += "<tr>", Xe ? (t = nn(0, 0), e = on(t, Ve), Ye ? e += Je : e = Je + e, a += "<td class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</td>") : a += "<td class='fc-agenda-axis " + r + "'>&nbsp;</td>", n = 0; We > n; n++) t = nn(0, n), a += "<td class='fc-" + ke[t.getDay()] + " fc-col" + n + " " + r + "'><input type='button' style='float: right; height: 36px; margin: 0 0 0 10px; width: 50px;' class='change-pic-nav' value='Print' name='print' onclick='printdt("+t.getDate()+","+t.getMonth()+","+t.getYear()+");'></td>";
            
             
            
            return a += "<th class='fc-agenda-gutter " + r + "'>&nbsp; </td>" + "</tr>" + "</thead>"
        }
