...
(function (l, ga) {
    ...
    function Db(a, b, f) {
        ...
        function z(q) {
            if (!v || q != v.name) {
                ...
                else v = i[q] = new Fa[q](J = j = l("<div class='fc-view fc-view-" + q + "' style='position:absolute'/>").appendTo(I), W);
        ...
        function va(q, x) {
            if (b[q]) return b[q].apply(x || Q, Array.prototype.slice.call(arguments, 2))
        }
        var W = this;
        W.options = b;
        W.render = e;
        ...
        W.trigger = va;
        Fb.call(W, b, f);
        var w = W.isFetchNeeded,
            K = W.fetchEvents,
            Q = a[0],
            L, D, I, P, v, i = {}, k, E, j, d = 0,
            n = 0,
            t = new Date,
            U = [],
            Z;
                    ...
                    l.each(this.split(","), function (X, la) {
                        if (la == "title") {
                            ...
                            if (oa) {
                                ...
                                if (X) aa = l("<div class='fc-button-" +
                                    la + " ui-state-default'><a><span class='ui-icon ui-icon-" + X + "'/></a></div>");
                                else if (ka) aa = l("<div class='fc-button-" + la + " " + r + "-state-default'><a><span>" + ka + "</span></a></div>");
                                if (aa) {
                                    aa.click(function () {
    ...
    function Fb(a, b) {
        ...
        function u(c) {
            var B, F = V.length,
                G, fa = X().defaultEventEnd,
                na = c.start - c._start,
                ia = c.end ? c.end - (c._end || fa(c)) : 0;
            for (B = 0; B < F; B++) {
                G = V[B];
                if (G._id == c._id && G != c) {
        ...
        function N(c) {
            if (c) {
                ...
                for (F = 0; F < b.length; F++)
                    if (typeof b[F] == "object") b[F] = l.grep(b[F], c, true)
            } else {
                V = [];
        ...
        function Y(c) {
            ...
            if (c.allDay === ga) c.allDay = a.allDayDefault;
            if (c.className) {
    ...
    function Ya(a, b, f) {
        function e(j, d, n) {
            ...
            if (P) {
                ...
                P.find("td").each(function () {
                    var ma = l(this);
                    if (w > 1) J.getMonth() == Z ? ma.removeClass("fc-other-month") : ma.addClass("fc-other-month"); + J == +q ? ma.removeClass("fc-not-today").addClass("fc-today").addClass(t +
        ...
        function g(j) {
            ...
            var d = D - I.height(),
                n;
            if (V("weekMode") == "variable") n = d = Math.floor(d / (w == 1 ? 2 : 6));
            else {
                n = Math.floor(d / w);
                d = d - n * (w - 1)
            } if (Za === ga) {
        ...
        function u(j, d, n) {
            ...
            for (var t = S(C(n), K), U = 0; U < w; U++) {
                var Z = new Date(Math.max(n, j)),
                    q = new Date(Math.min(t, d));
                if (Z < q) {
                    var x;
                    if (ia) {
                        x = Aa(q, n) * H + T + 1;
        ...
        function oa(j) {
            return {
                row: Math.floor(Aa(j, A.visStart) / 7),
                col: la(j.getDay()) * H + T
            }
        }
        ...
        var V = A.opt,
            ...
            F = A.renderOverlay,
            G = A.clearOverlays,
            fa = A.daySelectionMousedown,
            na = b.formatDate,
            ia, H, T, va, W, w, K, Q, L, D, I, P, v, i, k, E;
        ob(a.addClass("fc-grid"));
        i = new pb(function (j, d) {
            var n,
                t, U, Z = P.find("tr:first td");
            if (ia) Z = l(Z.get().reverse());
            Z.each(function (q, x) {
                n = l(x);
                t = n.offset().left;
                if (q) U[1] = t;
    ...
    function tb(a, b, f) {
        function e(o) {
            ...
            if (v) {
                ...
                j.find("td").each(function (Ja, ya) {
                    ya.className = ya.className.replace(/^fc-\w+(?= )/, "fc-" + Ca[y.getDay()]); + y == +M ? l(ya).removeClass("fc-not-today").addClass("fc-today").addClass(ja + "-state-highlight") : l(ya).addClass("fc-not-today").removeClass("fc-today").removeClass(ja +
                        "-state-highlight");
                    S(y, ea);
                    $ && ta(y, ea)
                })
            } else {
                var ba, ua, Da = T("slotMinutes") % 15 == 0,
                    ra = "<div class='fc-agenda-head' style='position:relative;z-index:4'><table style='width:100%'><tr class='fc-first" + (T("allDaySlot") ? "" : " fc-last") + "'><th class='fc-leftmost " + ja + "-state-default'>&nbsp;</th>";
                for (ba = 0; ba < d; ba++) {
                ...
                if (T("allDaySlot")) ra += "<tr class='fc-all-day'><th class='fc-axis fc-leftmost " +
        ...
        function O(o) {
            if (!T("selectable")) {
                ...
                } else va("dayClick", this, y, true, o)
            }
        }
        ...
        function Y(o, y) {
            for (var M = C(H.visStart), R = S(C(M), 1), ba = 0; ba < d; ba++) {
                var ua = new Date(Math.max(M, o)),
                    Da = new Date(Math.min(R, y));
                if (ua < Da) {
                    var ra = ba * ea + pa;
        ...
        function la(o) {
            return {
                row: Math.floor(Aa(o, H.visStart) / 7),
                col: X(o.getDay())
            }
        }
        ...
        function oa(o, y) {
            o = C(o, true);
            if (y < sa(C(o), xa)) return 0;
            if (y >= sa(C(o), Ba)) return k.height();
            o = T("slotMinutes");
            y = y.getHours() * 60 + y.getMinutes() - xa;
            var M = Math.floor(y / o),
                R = db[M];
            if (R === ga) R = db[M] = i.find("tr:eq(" + M + ") td div")[0].offsetTop;
        ...
        function B(o, y, M) {
            if (M) T("allDaySlot") && r(o, S(C(y), 1), true);
            else F(o, y)
        }
                        ...
                        if (l.isFunction(M)) {
                            ...
                            za =
                                l(I({
                                    ...
                                    className: [],
                                    editable: false
                                }, R, "fc-event fc-event-vert fc-corner-top fc-corner-bottom "));
        ...
        var T = H.opt,
            ...
            P = b.formatDate,
            v, i, k, E, j, d, n = 0,
            t, U, Z, q, x, J, ja, ma, $, qa, ea, pa, xa, Ba, wa, Ka, Qa, db = {}, za, ub, wb;
        ...
        wa = new pb(function (o, y) {
            ...
            for (var Da = k.offset().top, ra = i.offset().top, cb = ra + i.outerHeight(), Ja = 0; Ja < n; Ja++) o.push([M(Da + Z * Ja), M(Da + Z * (Ja + 1))])
        });
        Ka = new qb(wa);
    ...
    function Nb() {
        ...
        function h(i, k) {
            ...
            for (E = 0; E < j; E++) {
                ...
                if (d.isStart) t += "fc-corner-top ";
                if (d.isEnd) t += "fc-corner-bottom ";
                U = c(d.start, d.start);
                Z = c(d.start, d.end);
                q = d.col;
                x = d.level;
        ...
        function N(i, k, E) {
            if (!s("disableDragging") && k.draggable) {
                ...
                k.draggable({
                    ...
                    stop: function (qa, ea) {
                        ...
                        Y("eventDragStop", k, i, qa,
                            ea);
                        if (pa && (n || t || d)) K(this, i, n, d ? 0 : t, d, qa, ea);
                        else {
                            $();
                            k.css(j);
                            ma(0);
                ...
                function ma(qa) {
                    var ea = sa(C(i.start), qa),
                        pa;
                    if (i.end) pa = sa(C(i.end), qa);
            ...
            if (!s("disableResizing") && k.resizable) {
                ...
                k.resizable({
                    ...
                    stop: function (t, U) {
                        ...
                        if (j) Q(this, i, 0, s("slotMinutes") * j, t, U);
                        else {
                            k.css("z-index", 8);
                            W(i, k)
                        }
    ...
    function lb(a, b, f) {
        ...
        function z(c, B) {
            B.click(function (F) {
                if (!B.hasClass("ui-draggable-dragging") && !B.hasClass("ui-resizable-resizing")) return g("eventClick", this, c, F)
            }).hover(function (F) {
        ...
        function ha(c, B, F, G) {
            ...
            for (var fa, na = c.length, ia = 0; ia < na; ia++) {
                ...
                sa(S(fa.start, B, true),
                    F);
                if (fa.end) fa.end = sa(S(fa.end, B, true), F);
                oa(fa, V)
            }
        }
                    ...
                    if (I.which == 1) {
                        ...
                        v.start(function (q, x) {
                            if (q) {
                                ...
                                q = q.col;
                                if (i == 1) J = 0;
                                if (J == Z.row) q = L ? Math.min(Z.col, q) : Math.max(Z.col, q);
    ...
    function nb() {
        ...
        h("selectable") && h("unselectAuto") && l(document).mousedown(function (O) {
            ...
            if (r)
                if (l(O.target).parents(r).length) return;
            b(O)
        })
    }
    ...
    function gb(a, b) {
        if (+a)
            for (; a.getDate() != b.getDate();) a.setTime(+a + (a < b ? 1 : -1) * Rb)
    }
