...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
		...
		eventDrop: function(event) {
			...
			var url = plgFcRoot + "/events/update?id="+event.id+"&start="+startyear+"-"+startmonth+"-"+startday+" "+starthour+":00:00&end="+endyear+"-"+endmonth+"-"+endday+" "+endhour+":00:00&allday="+allday;
		...
		eventResize: function(event) {
			...
			var endhour = enddate.getHours();
			var endminute = enddate.getMinutes();
			var url = plgFcRoot + "/events/update?id="+event.id+"&start="+startyear+"-"+startmonth+"-"+startday+" "+starthour+":00:00&end="+endyear+"-"+endmonth+"-"+endday+" "+endhour+":00:00";
