...
$(window).load(function() {
	...
	.toggleClick(function(){
		$mrova_feedback.animate({'right':'0'},1000);
	}, function(){
	...
	$('#mrova-sendbutton').click( function() {
				//var url = 'send.php';
				var url = '/platformProject/index/feedback';
				var error = 0;
				...
				if(error > 0) {
					...
					$('#mrova-sendbutton').attr('disabled', 'disabled');
					$('#mrova-sendbutton').css('background', '#F5F5F5');
